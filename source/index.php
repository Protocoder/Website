          ...
          <div class="container">
            ...
            <div class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                ...
                <li id = "contribute"><a href="https://github.com/Protocoder/Protocoder/wiki">Contribute</a></li>
        ...
        <div class="item active" id = "bg-header">
          <div class="container">
            <div class="carousel-caption">
              <h1>Open Source Experimentation sandbox for Android</h1>
              <p id = "description-header">For and by tinkers, researchers, & makers. A framework to learn and experiment with. </p>
              <p>
              	<a class="btn btn-lg btn-primary" href="#download" role="button">Download</a>
                <!-- <a class="btn btn-lg btn-primary" href="https://github.com/Protocoder/Protocoder" role="button">Fork me on Github!</a>-->
              </p>
            </div>
          </div>
        </div>
    ...
    <div class="container marketing">
      ...
      <div class="row">
        <div class="span-12 pagination-centered">
          ...
          <p>Protocoder is a coding environment + Javascript framework for quick prototyping and experimentation on Android devices. Just download the app on your phone and you are ready to go. 
      ...
      <div class="row">
        <div class="col-lg-6 pagination-centered">
          ...
          <p>Install the app in your Android device and access the web IDE from your computer. Code in javascript using the Protocoder framework. No need to write dozends of lines to access sensors or write an UI, simple to use, fast to code.</p>
  ...
  ui.addVideo("fileName", 0, 0, 500, 200);
      ...
      <div class="row featurette">
        <div class="col-md-7">
          ...
          <p class="lead">Protocoder is an environment that you can carry in your pocket. You might go to a different computer and you will still have the same IDE accessible from any modern web browser. 
    ...
    <hr class="featurette-divider">
  	<div class="row featurette">
        ...
        <div class="col-md-7">
          ...
          <p class="lead">Select the lines, press Cmd / Control + Shift + X and see how things change on your device. Once you master it, you will wonder why mobile development tools don't have this as default.</p>
        </div>
      </div>
    ...
    <hr class="featurette-divider">
     ...
     <div class="row">
        ...
        <h1>Download</h1>
            ...
            <p>Download the apk in your phone. Dont forget to enable <i>installing apps for unknown sources</i>. 
            ...
            <a class="btn btn-lg btn-primary" href="./downloads/protocoder-normal-0_10_0.apk" role="button">Download Normal APK v0.10.0</a>
            <a class="btn btn-lg btn-primary" href="./downloads/protocoder-extended-0_10_0.apk" role="button">Download Extended APK v0.10.0</a>

			<!-- <a class="btn btn-lg btn-primary" href="./downloads/protocoder-normal-0_97.apk" role="button">Download Normal APK v0.97</a> -->
            <!-- <a class="btn btn-lg btn-primary" href="./downloads/protocoder-extended-0_97.apk" role="button">Download Extended APK v0.97</a> -->


         	<br />
         	<br />
         	<p>
         	<i> Last version 0.10.0 released the 26/03/2015 </i> <a href = "./downloads/protocoder-0_10_0-changelog.txt"> Changelog </a>
         	<!-- <i> Last version 0.97 released the 09/12/2014 </i> <a href = "./downloads/protocoder_097_changelog.txt"> Changelog </a> -->
            ...
            -->  
            <p>
            If you know a bit of adb trickery you can still use Protocoder with a <strong>USB cable</strong>. Just write this command line in your system console and then go to http://localhost:8585 in your browser. Please note that you need to install adb in your system. 
            </p>
    ...
    > adb forward tcp:8587 tcp:8587</pre>
      ...
      <div class="row">
        <div class="span-12 pagination-centered">
          <img class="img-circle" src="./docs-assets/images/separation.png" alt="separation">
          <h2>License</h2>
          <p>Protocoder is released as open source under the <a href="https://www.gnu.org/licenses/lgpl.html">LGPL license.</a> I guess you know what it means but if you don't here are the most important points </p>
          <ul>
          	<li>If you make changes to Protocoder itself you will have to release that code open source</li>
          	<li>You can make an app using Protocoder and you don't have to release your code, although if you do the better, so everybody will learn from it!</li>
          </ul> 
        </div><!-- /.col-lg-4 -->
      </div>
      ...
      <div class="row">
          ...
          <img class="img-circle" src="./docs-assets/images/separation.png" alt="separation">
          <h2>Credits</h2>
          <p>Protocoder is a project originated by Victor Diaz developed using a nomadic approach in different contexts that varies from this or that country, parks, libraries, hotel lobbies, cafes, restaurants, cars, here and there. </p>
          ...
          <p>Special thanks to José Juan Sánchez Hernández, Maciej Górski, bq.com, Ali Javidan, Gopi Palaniappan, Alan Sien and the MWM Crew :)</p>
          <!--
          <p>
...
<!--         <a href = "http://www.youtube.com/channel/UCv_npDT0QRW9lXAzSpZDocg?feature=watch"><i class="fa fa-youtube fa-2x"></i></a> -->
        <a href = "https://github.com/Protocoder"><i class="fa fa-github-alt fa-2x"></i></a> 
        <!-- 
